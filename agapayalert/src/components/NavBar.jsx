// filepath: /c:/agapayalert/AgapayAlert-Web/agapayalert/src/components/NavBar.jsx
...
const NavBar = () => {
  ...
  return (
    <nav className="sticky top-0 bg-white px-8 py-2 backdrop-blur-sm bg-opacity-70 z-10">
      <div className='flex flex-row justify-between'>
        <img src={logo} alt='AGAPAYALERT' className='h-14 w-14' />
        <div className="flex flex-row place-items-center space-x-16 pl-16">
        ...
        <div className="flex place-items-center pr-16">
          {isAuthenticated ? (
